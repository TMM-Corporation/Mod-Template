...
MAIN {
	// create all modules
	Module* main_module = new MainModule("template_library");
	// to create module hierarchy, create modules with additional parent parameter in constructor
	new OtherModule(main_module, "template_library.other_module");
}
...
JS_MODULE_VERSION(TemplateNativeModule, 1)
...
JS_EXPORT(TemplateNativeModule, hello, "I(II)", (JNIEnv* env, int value1, int value2) {
